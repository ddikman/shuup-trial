...
# There is an issue with sqlite3 database, so I change to use postgres
...
MEDIA_ROOT = root(env('MEDIA_LOCATION', default=os.path.join(BASE_DIR, 'media')))
# STATIC_ROOT = root(env('STATIC_LOCATION', default=os.path.join(BASE_DIR, 'static')))
